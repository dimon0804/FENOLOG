...
PROGRESS = [
    ...
    ("Baseline организаторов:\nсреднее двух соседей", 0.0915, False),
    ("Первая конфигурация проекта:\nсмесь 50/50", 0.0858, False),
    ...
    ("E08. Финальная конфигурация", 0.0642, False),
]
...
def figure_3_progress() -> None:
    ...
    ax.set_title("Что дал каждый эксперимент: −30 % RMSE к baseline организаторов")
