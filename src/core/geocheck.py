...
по трём независимым каналам, и это принципиально: совпадение трёх независимых
...
def verify_polygon(
    ...
    out: dict = {
        ...
        "satellite": None, "map": None, "shift": None,
    ...
    if out["problems"]:
        ...
        out["verdict"] = (
            f"координаты подтверждены независимо двумя источниками "
            f"({' и '.join(out['confirmed_by'])}): по этим координатам действительно "
