...
8. **Связывает просадки с журналом полевых работ.** Агроном вводит, что и когда
...
Регион выбирается на «Обзоре» в блоке быстрого старта и дальше остаётся в шапке.
Список районов не зашит: за плашкой открывается поиск по геокодеру, поэтому
подходит любое название — район, станица, область.
