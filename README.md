...
| Раздел | Что в нём |
| --- | --- |
| Обзор | показатели по всем сохранённым полям и быстрый старт |
| Карта | основной сценарий целиком: карта плюс разбор выбранного поля |
| Участки | таблица сохранённых полей: пересчёт, переименование, удаление |
| Аналитика | сводка по хозяйству и сравнение полей на одном графике |
