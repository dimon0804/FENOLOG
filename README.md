...
5. Сохранить поле. Оно останется в списке слева; при следующем открытии прошлый
   разбор показывается сразу, без нового сбора.
...
Recharts для графиков, сборка через vite.
